    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                int nameCompare = ((String) stock1.get("name")).toLowerCase().compareTo(((String) stock2.get("name")).toLowerCase());
                if (nameCompare < 0)
                    return -1;
                ...
                if (dateCompare > 0)
                    ...
                    return 1;
                double change1 = stock1.containsKey("open") ? (double) stock1.get("last") - (double) stock1.get("open") : (double) stock1.get("change");
                double change2 = stock2.containsKey("open") ? (double) stock2.get("last") - (double) stock2.get("open") : (double) stock2.get("change");
                if (change1 > change2)
                    return -1;
